...
export default function App() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    setError({ error: false, message: "problema" });
    setLoading(true);

    try {
      if (!city.trim()) throw { message: "Escriba algo, por favor" };
      ...
      await axios.post('http://localhost:3000/api/historial', weatherData);
